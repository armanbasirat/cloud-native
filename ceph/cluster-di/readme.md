...
```
ceph osd pool create k8s-di-cephfs-data
ceph osd pool create k8s-di-cephfs-metadata
ceph fs new k8s-di-fs k8s-di-cephfs-metadata k8s-di-cephfs-data
ceph fs subvolumegroup create k8s-di-fs k8s-di-svg
```

## 18- create user for k8s

```
user_name=k8s-di-cluster-cephfs
fs_name=k8s-di-cluster-fs
metadata_name=k8s-di-cluster-cephfs-metadata
data_name=k8s-di-cluster-cephfs-data
svg_name=k8s-di-cluster-svg
```
